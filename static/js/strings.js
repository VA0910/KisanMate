...
(function (global) {
  ...
  var STRINGS = {
    en: {
      ...
      phoneInstruction: "Enter your phone number and we'll send you a code.",
      phoneLabel: "Phone number",
      phonePlaceholder: "10-digit mobile number",
      phoneInvalid: "Please enter your 10-digit mobile number.",
      sendCode: "Send code",
      otpRequestError: "We couldn't send the code right now. Please try again.",
      otpTitle: "Enter the code",
      otpSentTo: function (phone) { return "We sent a code to " + phone + "."; },
      ...
      profileSetupIntro: "Welcome! Tell us your name to get started. You can add your farm details next.",
      profileNameLabel: "Your name",
      profileNamePlaceholder: "e.g. Ramesh",
    ...
    hi: {
      ...
      continueBtn: "होम पर जाएं",
      signOut: "साइन आउट",
      signedOut: "आप साइन आउट हो गए हैं।",
      phoneTitle: "अपने फ़ोन से साइन इन करें",
      phoneInstruction: "अपना फ़ोन नंबर डालें, हम आपको एक कोड भेजेंगे।",
      phoneLabel: "फ़ोन नंबर",
      phonePlaceholder: "10 अंकों का मोबाइल नंबर",
      phoneInvalid: "कृपया अपना 10 अंकों का मोबाइल नंबर डालें।",
      sendCode: "कोड भेजें",
      otpRequestError: "अभी कोड नहीं भेज पाए। कृपया फिर से कोशिश करें।",
      otpTitle: "कोड डालें",
      otpSentTo: function (phone) { return "हमने " + phone + " पर एक कोड भेजा है।"; },
      demoOtpLabel: "डेमो OTP",
      otpLabel: "4 अंकों का कोड",
      otpInvalid: "यह कोड मेल नहीं खाता। कृपया फिर से कोशिश करें।",
      verifyCode: "पुष्टि करें और आगे बढ़ें",
      changeNumber: "नंबर बदलें",
      profileSetupTitle: "अपनी प्रोफ़ाइल बनाएं",
      profileSetupIntro: "स्वागत है! शुरू करने के लिए अपना नाम बताएं। खेत की जानकारी आप आगे जोड़ सकते हैं।",
      profileNameLabel: "आपका नाम",
      profileNamePlaceholder: "जैसे रमेश",
    ...
    te: {
      ...
      continueLabel: "కొనసాగండి",
      continueBtn: "హోమ్‌కు వెళ్ళండి",
      signOut: "సైన్ అవుట్",
      signedOut: "మీరు సైన్ అవుట్ అయ్యారు.",
      phoneTitle: "మీ ఫోన్‌తో సైన్ ఇన్ చేయండి",
      phoneInstruction: "మీ ఫోన్ నంబర్ నమోదు చేయండి, మేము మీకు కోడ్ పంపుతాము.",
      phoneLabel: "ఫోన్ నంబర్",
      phonePlaceholder: "10 అంకెల మొబైల్ నంబర్",
      phoneInvalid: "దయచేసి మీ 10 అంకెల మొబైల్ నంబర్ నమోదు చేయండి.",
      sendCode: "కోడ్ పంపండి",
      otpRequestError: "ప్రస్తుతం కోడ్ పంపలేకపోయాము. దయచేసి మళ్ళీ ప్రయత్నించండి.",
      otpTitle: "కోడ్ నమోదు చేయండి",
      otpSentTo: function (phone) { return "మేము " + phone + " కు కోడ్ పంపాము."; },
      demoOtpLabel: "డెమో OTP",
      otpLabel: "4 అంకెల కోడ్",
      otpInvalid: "ఈ కోడ్ సరిపోలడం లేదు. దయచేసి మళ్ళీ ప్రయత్నించండి.",
      verifyCode: "నిర్ధారించి కొనసాగండి",
      changeNumber: "నంబర్ మార్చండి",
      profileSetupTitle: "మీ ప్రొఫైల్‌ను సెటప్ చేయండి",
      profileSetupIntro: "స్వాగతం! ప్రారంభించడానికి మీ పేరు చెప్పండి. మీ పొలం వివరాలను తర్వాత జోడించవచ్చు.",
      profileNameLabel: "మీ పేరు",
      profileNamePlaceholder: "ఉదా. రమేష్",
